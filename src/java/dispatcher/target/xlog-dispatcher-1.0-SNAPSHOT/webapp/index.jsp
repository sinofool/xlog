...
<table width="20%" class="tabinfo1" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td nowrap="nowrap"><input type="button" id="stop" name="stop" onClick="operate('stop');" value="停止" disabled="true"/></td>
		<%
			}else{
		%>
		<td nowrap="nowrap"><input type="button" id="start" name="start" value="启动"  disabled="true"/></td>	
		<td nowrap="nowrap"><input type="button" id="stop" name="stop" value="停止"/></td>
		<%
			}
		%>
	</tr>
...
<table width="30%" class="tabinfo1" border="0" cellspacing="3" cellpadding="0">
	<tr>
		<td align="left">Namespace</td>
		<td align="left">当前队列大小</td>
		<td align="left">发送成功数量</td>
		<td align="left">发送失败数量</td>
	</tr>
